...
abstract class Author implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\MaterialBot\\Map\\AuthorTableMap';
    ...
    /**
     * Initializes internal state of MaterialBot\Base\Author object.
     */
     ...
     * @return $this|\MaterialBot\Author The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\MaterialBot\\Author'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\MaterialBot\Author
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\MaterialBot\Author The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MaterialBot\Author (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MaterialBot\Author Clone of current object.
     * @throws PropelException
     */
