...
namespace MaterialBot\Base;

use \Exception;
use \PDO;
use MaterialBot\Book as ChildBook;
use MaterialBot\BookQuery as ChildBookQuery;
use MaterialBot\Map\BookTableMap;
 ...
 *
 * @method     \MaterialBot\PublisherQuery|\MaterialBot\AuthorQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildBook> findByTitle(string $title) Return ChildBook objects filtered by the title column
 * @method     ChildBook[]|ObjectCollection findByISBN(string $isbn) Return ChildBook objects filtered by the isbn column
 * @psalm-method ObjectCollection&\Traversable<ChildBook> findByISBN(string $isbn) Return ChildBook objects filtered by the isbn column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildBook> findByPublisherId(int $publisher_id) Return ChildBook objects filtered by the publisher_id column
 * @method     ChildBook[]|ObjectCollection findByAuthorId(int $author_id) Return ChildBook objects filtered by the author_id column
 * @psalm-method ObjectCollection&\Traversable<ChildBook> findByAuthorId(int $author_id) Return ChildBook objects filtered by the author_id column
...
abstract class BookQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \MaterialBot\Base\BookQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\MaterialBot\\Book', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \MaterialBot\Publisher object
     *
     * @param \MaterialBot\Publisher|ObjectCollection $publisher The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($publisher instanceof \MaterialBot\Publisher) {
            return $this
            ...
            throw new PropelException('filterByPublisher() only accepts arguments of type \MaterialBot\Publisher or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \MaterialBot\PublisherQuery A secondary query class using the current class as primary query
     */
    public function usePublisherQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinPublisher($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Publisher', '\MaterialBot\PublisherQuery');
    }

    /**
     * Use the Publisher relation Publisher object
     *
     * @param callable(\MaterialBot\PublisherQuery):\MaterialBot\PublisherQuery $callable A function working on the related query
     *
     ...
     *
     * @return \MaterialBot\PublisherQuery The inner query object of the EXISTS statement
     */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \MaterialBot\PublisherQuery The inner query object of the NOT EXISTS statement
     */
    ...
    /**
     * Filter the query by a related \MaterialBot\Author object
     *
     * @param \MaterialBot\Author|ObjectCollection $author The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($author instanceof \MaterialBot\Author) {
            return $this
            ...
            throw new PropelException('filterByAuthor() only accepts arguments of type \MaterialBot\Author or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \MaterialBot\AuthorQuery A secondary query class using the current class as primary query
     */
    public function useAuthorQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinAuthor($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Author', '\MaterialBot\AuthorQuery');
    }

    /**
     * Use the Author relation Author object
     *
     * @param callable(\MaterialBot\AuthorQuery):\MaterialBot\AuthorQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     * @param string $typeOfExists Either ExistsCriterion::TYPE_EXISTS or ExistsCriterion::TYPE_NOT_EXISTS
     *
     * @return \MaterialBot\AuthorQuery The inner query object of the EXISTS statement
     */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \MaterialBot\AuthorQuery The inner query object of the NOT EXISTS statement
     */
