 ...
 *
 *
 * @package    propel.generator.MaterialBot.Base
 */
abstract class Publisher implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\MaterialBot\\Map\\PublisherTableMap';
    ...
    /**
     * Initializes internal state of MaterialBot\Base\Publisher object.
     */
     ...
     * @return $this|\MaterialBot\Publisher The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\MaterialBot\\Publisher'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\MaterialBot\Publisher
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\MaterialBot\Publisher The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MaterialBot\Publisher (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MaterialBot\Publisher Clone of current object.
     * @throws PropelException
     */
    ...
    public function initBooks($overrideExisting = true)
    {
        ...
        $this->collBooks->setModel('\MaterialBot\Book');
    }
        ...
        if (null === $this->collBooks || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collBooks) {
                    ...
                    $collBooks->setModel('\MaterialBot\Book');
