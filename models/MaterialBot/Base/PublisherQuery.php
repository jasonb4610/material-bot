...
use \Exception;
use \PDO;
use MaterialBot\Publisher as ChildPublisher;
use MaterialBot\PublisherQuery as ChildPublisherQuery;
use MaterialBot\Map\PublisherTableMap;
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildPublisher> findById(int $id) Return ChildPublisher objects filtered by the id column
 * @method     ChildPublisher[]|ObjectCollection findByName(string $name) Return ChildPublisher objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildPublisher> findByName(string $name) Return ChildPublisher objects filtered by the name column
...
abstract class PublisherQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \MaterialBot\Base\PublisherQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\MaterialBot\\Publisher', $modelAlias = null)
    {
