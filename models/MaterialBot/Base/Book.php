...
abstract class Book implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\MaterialBot\\Map\\BookTableMap';
    ...
    /**
     * Initializes internal state of MaterialBot\Base\Book object.
     */
     ...
     * @return $this|\MaterialBot\Book The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\MaterialBot\\Book'), 0, $e);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\MaterialBot\Book The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MaterialBot\Book (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MaterialBot\Book Clone of current object.
     * @throws PropelException
     */
