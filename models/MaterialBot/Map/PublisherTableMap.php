...
use MaterialBot\Publisher;
use MaterialBot\PublisherQuery;
...
class PublisherTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'MaterialBot.Map.PublisherTableMap';
     ...
     */
    const OM_CLASS = '\\MaterialBot\\Publisher';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'MaterialBot.Publisher';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\MaterialBot\\Publisher');
    ...
    {
        $this->addRelation('Book', '\\MaterialBot\\Book', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \MaterialBot\Publisher) { // it's a model object
