...
namespace MaterialBot\Map;

use MaterialBot\Book;
use MaterialBot\BookQuery;
...
class BookTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'MaterialBot.Map.BookTableMap';
     ...
     */
    const OM_CLASS = '\\MaterialBot\\Book';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'MaterialBot.Book';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\MaterialBot\\Book');
        $this->setPackage('MaterialBot');
    ...
    {
        $this->addRelation('Publisher', '\\MaterialBot\\Publisher', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
        ...
        $this->addRelation('Author', '\\MaterialBot\\Author', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':author_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \MaterialBot\Book) { // it's a model object
