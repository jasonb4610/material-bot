...
use MaterialBot\Author;
use MaterialBot\AuthorQuery;
...
class AuthorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'MaterialBot.Map.AuthorTableMap';
     ...
     */
    const OM_CLASS = '\\MaterialBot\\Author';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'MaterialBot.Author';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\MaterialBot\\Author');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \MaterialBot\Author) { // it's a model object
